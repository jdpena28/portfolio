...
const birthdayMessage = () => {
  ...
  const addBirthdayMessage = async (e: FormEvent<HTMLFormElement>) => {
    ...
    await addDoc(birthdayCollection, {
      birthday_name: birthdayMessage?.name,
      birthday_message: birthdayMessage?.message,
    })
      .then(() => {
        sucessToast();
            ...
            <div className="sm:flex justify-between">
              <div className="sm:w-[70%]">
                ...
                <p className="text-xl sm:text-sm font-light sm:w-[60%] mb-8">
                  I have some extra wishes for my <b>Birthday</b>. This will
                  help me to attain my dream <u>Career</u>
                </p>
              </div>
