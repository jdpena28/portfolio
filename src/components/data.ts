...
export const project = [
	...
	{
		flex: 'flex-row-reverse',
		src: '/Projects/1Bataan-Travel-Pass.png',
		title:  '1Bataan Travel Pass',
		desc: "A School Project with CRUD functionality & QR Code link that can be shared and scan to get details of traveller.",
		color: 'yellow',
		num:'04',
		titleClass: 'top-[20%] right-[40.3%] mix-blend-difference',
		descClass:'text-right sm:text-left',
		hoverClass: 'flex-row-reverse sm:flex-row',
		hoverDesc: 'Nuxt.js, Vue.js, Tailwind, Firebase',
		github:'https://github.com/jdpena28/travel-pass-web-based',
		link:'https://travel-pass-web-based.vercel.app',
		imgAOS: 'fade-up-left',
		textAOS: 'slide-left',
	},
]